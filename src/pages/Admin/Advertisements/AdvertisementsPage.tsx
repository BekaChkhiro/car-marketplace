...
const AdvertisementsPage: React.FC = () => {
  ...
  const getAddPath = () => {
    if (currentPath.includes('slider')) {
      return '/admin/advertisements/new?placement=home_slider';
    } else if (currentPath.includes('banners')) {
      return '/admin/advertisements/new?placement=home_banner';
    } else if (currentPath.includes('sidebar')) {
      return '/admin/advertisements/new?placement=sidebar';
    }
    return '/admin/advertisements/new';
  };
