    ...
    <div className="bg-white rounded-xl p-6 border">
      ...
      {(vipStatus !== 'none' || getVipPrice('none') > 0 || colorHighlighting || autoRenewal) && (
        <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <h4 className="font-medium mb-3">{t('addPart.vipStatus.priceSummary', { defaultValue: 'Price Summary' })}</h4>
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between font-semibold text-lg">
              <span>{t('parts.vip.modal.totalPrice')}:</span>
              <span className="text-blue-600">
                {formatPrice(getTotalPrice(vipStatus, vipDays))}
              </span>
            </div>
            <div className="flex justify-between text-xs text-gray-600">
              <span>{t('parts.vip.modal.yourBalance')}</span>
